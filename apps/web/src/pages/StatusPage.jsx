...
const OVERALL_STATUS = 'operational';
...
const INCIDENTS = [
  { date: 'May 15, 2026', title: 'Document Vault Slow Response', status: 'Resolved', description: 'Some users experienced slow document upload and retrieval times.', resolution: 'Root cause identified as a storage node rebalancing operation. Performance restored to normal after 23 minutes.', duration: '23 minutes' },
  { date: 'April 3, 2026', title: 'Scheduled Maintenance — API Updates', status: 'Completed', description: 'Planned maintenance window for API infrastructure upgrades.', resolution: 'Maintenance completed successfully. All services restored ahead of schedule.', duration: '45 minutes' },
  { date: 'March 18, 2026', title: 'Notification Delivery Delay', status: 'Resolved', description: 'Email notifications were delayed by 15–45 minutes for some users.', resolution: 'Queue backlog cleared. Delivery returned to normal. No notifications were lost.', duration: '31 minutes' },
];
...
const StatusPage = () => {
  ...
  return (
    <SiteLayout seo={{ title: 'System Status — HomeOS' }} fullWidth>
      <section style={{ background: overall.bg, padding: '64px 32px 48px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <h1 className="font-semibold text-white" style={{ fontSize: '40px', lineHeight: '1.15', marginBottom: '12px' }}>{overall.label}</h1>
          <p style={{ fontSize: '17px', color: 'rgba(255,255,255,0.75)', marginBottom: '16px' }}>Real-time uptime and service health for HomeOS.</p>

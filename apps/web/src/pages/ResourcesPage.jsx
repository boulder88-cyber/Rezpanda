...
const ARTICLES = [
  ...
  { type: 'using', tag: 'Documents', title: 'Keeping the papers that actually matter', desc: 'Deeds, policies, warranties, receipts — what\u2019s worth keeping in one findable place, and what isn\u2019t.', readTime: '5 min read', icon: FileText },
